...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { assignment_id: @grade.assignment_id, date: @grade.date, score: @grade.score, student_id: @grade.student_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { assignment_id: @grade.assignment_id, date: @grade.date, score: @grade.score, student_id: @grade.student_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
